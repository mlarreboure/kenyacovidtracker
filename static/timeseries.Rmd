...
#      dyLimit(limit = el1$i1_EL1[1], "Pre-COVID average, agricultural earnings",
#    strokePattern = "dotted", color = "blue") %>%
#      dyLimit(limit = el1$i3_EL1[1], "Pre-COVID average, wage earnings",
