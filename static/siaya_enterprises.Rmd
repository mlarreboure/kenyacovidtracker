...
<font size="5">**Total hours worked by all employees on the past 7 days**</font> 
...
``` {r loan}
  ...
  dyAxis("x", pixelsPerLabel = 90 , drawGrid = FALSE, label = "Weeks") %>% #grid
  dyAxis("y", label = "% Received external funding", drawGrid = FALSE, valueRange = c(0, 22)) %>% 
  dyLegend(width = 500, labelsSeparateLines = FALSE) %>%
...
Percentage of firms accepting mobile payments, and the share of mobile payments among firms that accept mobile payments. 
