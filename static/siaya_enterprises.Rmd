...
covid_weekly <- read_dta("../../GE_Endline2/covid19/data/COVID_AllHHs_outcomes_weekly_c.dta") # For agriculural ent.
...
ag <- ag[ag$week < 5,] # exclude last week of data (few observations)
...
tmp <- rbind(tmp, c(7, NA,NA,NA,NA)) # Setting week 7 to missing values
rev_prof_s <- tmp
